...
async def save_fact_check(
    ...
    Args:
        ...
        accuracy_confidence: Confidence level (0-100) for accuracy (i.e. true-true).
        falsehood_confidence: Confidence level (0-100) for falsehood (i.e. true-false).
    ...
    try:
        ...
        await doc_ref.set({
            ...
            "falsehood_confidence": falsehood_confidence,
            "verdict": verdict,
            "sources": sources,
